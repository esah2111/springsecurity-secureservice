package com.esah2111.springsecuritysecureservice;
...
public class SpringsecuritySecureserviceApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringsecuritySecureserviceApplication.class, args);
	}
